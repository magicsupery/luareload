...
-------------------------------------------------------------------------------
function logging:prepareLogMsg(date, level, name, message)
    self.concat[1] = date
    self.concat[2] = level
	self.concat[3] = name
	self.concat[4] = message
	return table.concat( self.concat, "     ")
end
...
function LogManager.getLogger(name)
	return logging.new( function(self, level, message)
		print(logging.prepareLogMsg(self, os.date(), level, name, message))
		return true
    end)
